class ValuesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @value.update(value_params)
        format.html { redirect_to album_url || root_url, notice: 'Value was successfully updated.' }
  ...
  def destroy
    @value.destroy
    respond_to do |format|
      format.html { redirect_to album_url || root_url, notice: 'Value was successfully destroyed.' }
